...
class params:
    ...
    def model(self):
        ...
        self.annLayers = [
            ...
            layers.ConvLSTM2D(filters=10, kernel_size=(4, 4), strides=1,padding="valid", return_sequences=True, activation=activation,name='clstm_0'),
            ...
            layers.Conv3DTranspose(filters=10,kernel_size=(1,4,4),activation=activation),
            layers.Conv3DTranspose(filters=1,kernel_size=(1,4,4),activation=activation),
